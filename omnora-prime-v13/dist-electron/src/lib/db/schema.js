...
exports.skuCache = (0, sqlite_core_1.sqliteTable)('sku_cache', {
    ...
    oemNumber: (0, sqlite_core_1.text)('oem_number'),
    compatibleVehicles: (0, sqlite_core_1.text)('compatible_vehicles'),
    commissionRate: (0, sqlite_core_1.text)('commission_rate').default('0'),
}, (table) => ({
...
exports.authorizedDevices = (0, sqlite_core_1.sqliteTable)('authorized_devices', {
    nodeId: (0, sqlite_core_1.text)('node_id').primaryKey(),
    meshKey: (0, sqlite_core_1.text)('mesh_key').notNull().default(''),
    ...
    businessId: (0, sqlite_core_1.text)('business_id'),
    deviceId: (0, sqlite_core_1.text)('device_id'), // the client-reported device UUID
    deviceLabel: (0, sqlite_core_1.text)('device_label'),
    lastSeen: (0, sqlite_core_1.text)('last_seen'),
    isRevoked: (0, sqlite_core_1.integer)('is_revoked').notNull().default(0),
    createdAt: (0, sqlite_core_1.text)('created_at').notNull().default((0, drizzle_orm_1.sql) `(datetime('now'))`),
}, (table) => ({
    businessIdx: (0, sqlite_core_1.index)('idx_auth_devices_business').on(table.businessId),
    deviceIdIdx: (0, sqlite_core_1.index)('idx_auth_devices_device_id').on(table.deviceId),
}));
