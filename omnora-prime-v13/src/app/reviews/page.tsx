  ...
  return (
    <div className="bg-[#030712] text-white font-sans min-h-screen selection:bg-[#08EBF6]/30 selection:text-white overflow-x-hidden relative flex flex-col justify-between">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
        <FloatingOrb color="rgba(8,235,246,0.06)" size={600} x="10%" y="20%" delay={0} blur={140} />
        <FloatingOrb color="rgba(95,165,250,0.04)" size={500} x="80%" y="70%" delay={3} blur={130} />
      </div>
      ...
      {/* Main Content */}
      <main className="relative z-10 flex-1 pt-36 pb-24 px-6 max-w-6xl mx-auto w-full flex flex-col">
        <SectionReveal className="text-center mb-16 space-y-4">
          <p className="text-xs font-black text-[#08EBF6] uppercase tracking-widest">Verified Testimonials</p>
          ...
          <div className="pt-2">
            <button
              ...
              className="inline-flex items-center gap-2 bg-gradient-to-r from-[#08EBF6] to-[#5FA5FA] text-black text-xs font-black uppercase tracking-widest px-6 py-3.5 rounded-md transition-all shadow-[0_0_25px_rgba(8,235,246,0.3)] hover:brightness-110"
            >
