          ...
          {!downloadUrl ? (
            ...
            >
              ...
              <button 
                ...
                className="w-full bg-electric-blue text-onyx py-5 font-bold uppercase tracking-widest text-sm flex items-center justify-center group rounded-sm disabled:opacity-20 cursor-pointer"
              >
              ...
              <div className="bg-surface/50 p-6 border border-white/5 space-y-4">
                 <div className="flex items-start space-x-3">
                    <Monitor size={16} className="text-gray-500 mt-0.5 shrink-0" />
                    <div>
