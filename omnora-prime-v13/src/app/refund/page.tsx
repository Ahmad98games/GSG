...
function RefundContent() {
  ...
  const sections: RefundSection[] = [
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          ...
          <p>
            Please provide your <strong className="text-white">Registered Business Email</strong>, the <strong className="text-white">License Key</strong>, and the invoice or transaction receipt number with your message. You may also email <a href="mailto:support@noxishub.app" className="text-[#C5A059] hover:underline">support@noxishub.app</a> (or <a href="mailto:support@noxis.app" className="text-[#C5A059] hover:underline">support@noxis.app</a>) to log the request.
          </p>
        </div>
      ),
    },
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <p>For any refund inquiries or billing disputes, reach out to us:</p>
          <div className="space-y-3">
            {[
              { label: "Billing & Support", email: "support@noxishub.app" },
              { label: "Alternative Support Email", email: "support@noxis.app" },
              { label: "Main Contact", email: "omnora@noxishub.app" },
              { label: "Legal Department", email: "legal@noxishub.app" },
            ].map((c) => (
